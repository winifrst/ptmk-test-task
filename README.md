...
├── build # Папка для скомпилированных бинарников  
├── Makefile # Скрипт сборки проекта  
├── README.md # Документация проекта  
├── src
│   ├── database.cpp/.h    # Работа с SQLite: создание таблицы, вставка, выборка, оптимизация    
│   ├── employee.cpp/.h    # Класс Employee, методы для работы с данными сотрудника   
│   ├── handlers.cpp/.h    # Обработчики флагов 1–6 (логика каждого режима)    
│   ├── main.cpp           # Точка входа приложения, разбор аргументов    
│   ├── namer.cpp/.h       # Генератор имён и фамилий  
│   ├── utils.cpp/.h       # Вспомогательные функции: генерация сотрудников, парсинг аргументов    
└── test                   # Тесты  
